...
const logos = [
  { id: 1, src: "/images/client.png", alt: "Abstract" },
  { id: 2, src: "/images/client.png", alt: "YinYangPaint" },
  { id: 3, src: "/images/client.png", alt: "TechLogo" },
  { id: 4, src: "/images/client.png", alt: "AbstractLogo" },
  { id: 5, src: "/images/client.png", alt: "AbstractLogo2" },
  { id: 6, src: "/images/client.png", alt: "Abstract2" },
];

function Testimonials2() {
  return (
    <div className="min-h-screen bg-[#2196f3] flex items-center justify-center p-8">
      <div className="max-w-6xl w-full bg-white rounded-lg p-12">
        <Swiper
          modules={[Navigation]}
          navigation={{
        ...
        <div className="mt-16 grid grid-cols-6 gap-8 items-center">
          {logos.map((logo) => (
            <img
              key={logo.id}
              src={logo.src}
              alt={logo.alt}
              className="h-12 object-contain grayscale opacity-50 hover:opacity-100 transition-opacity"
            />
          ))}
        </div>
      </div>
